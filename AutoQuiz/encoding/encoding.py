...
def beam_search_decoding(inp_ids, attn_mask, model, tokenizer, num_return_sequences=3):
    beam_output = model.generate(
        input_ids=inp_ids,
        attention_mask=attn_mask,
        max_length=256,
        num_beams=max(3, num_return_sequences),  # At least as many beams as outputs
